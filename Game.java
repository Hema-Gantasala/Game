...
class Game 
{
	String words[] = {"America","India","Australia","France","Russia","Japan","Korea","Africa","Cuba","Yemen"};
    ...
    if(score>8)
      System.out.println("WOW :) you did well!!);
		System.out.println("Wanna know your score?...It's : "+score);
	}
    ...
    System.out.println("Yeah there you are!!!!!! Reached the end of the game...&");
